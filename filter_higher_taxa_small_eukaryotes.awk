#! /usr/bin/gawk -f
###############################################################################
# script name: filter_higher_taxa_small_eukaryotes.awk
# path on oxygen: ?
...
###############################################################################
# How to run
# ./filter_higher_taxa_small_eukaryotes.awk /data/dictionary/ncbi/ncbi_taxanomy/nodes.dmp
# 
###############################################################################
...
END{
    ...
    for (selected_microbes in selected_microbe_high_level_taxa){
        ...
        print -2 FS selected_microbes FS ranks[selected_microbes] FS "unicellular eukaryotes";
